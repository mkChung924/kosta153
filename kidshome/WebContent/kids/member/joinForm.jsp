		...
		<form action="joindone.do" method="post" name="input">
			...
			<table border="1" cellpadding="5" width="600">
				...
				<tr>
					...
					<td colspan="3"><input type="text" name="tel1" size="3"
						maxlength="3" style="height: 15px"> <input type="text"
						name="tel2" size="4" maxlength="4" style="height: 15px"> <input
				...
				<tr align="center">
					<td colspan="4"><input type="button" value="가입" onclick="checkEmpty()"> 
