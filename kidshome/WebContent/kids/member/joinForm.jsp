...
<script type="text/javascript">
	...
	function checkEmpty() {
        ...
        if (form.id.value == "" || pass.value == "" || pass1.value == "" ||
           ...
           form.day.focus();
        }else if(!(idExp.test(id.value)) || id.value.length <5 || id.value.length > 10){
           ...
           form.day.focus();
        }else if((form.year.value < 1900) || (form.year.value > 2017) || form.year.value.length != 4){
           alert('년도 형식이 옳지 않습니다.');
           form.year.value='';
           form.year.focus();
        }else if(form.month.value > 12 || form.month.value <1 || form.month.value.length != 2){
           alert('월 형식이 옳지 않습니다.');
           form.month.value='';
           form.month.focus();
        }else if(form.day.value > 31 || form.day.value < 1 || form.day.value.length != 2){
           alert('일 형식이 옳지 않습니다.');
           form.day.value='';
           form.day.focus();
