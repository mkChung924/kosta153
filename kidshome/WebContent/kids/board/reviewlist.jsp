...
<body>
	...
	<center>
		...
		<table border='0' cellspacing=1 cellpadding=2 width='1100'>
			<tr bgcolor='#B7F0B1' align="center">
			...
			<tr bgcolor='ededed'  align="center">
				...
				<td><a href="reviewupdel.do?action=call&no=${Board.no }"> <font size=3 color="black">${Board.review_title }</font></a></td>
				<td><font size=3>${Board.user_id }</font></td>
				<td><font size=3>${Board.gdate }</font></td>
				<td><font size=3>${Board.review_count }</font></td>
			</tr>
			 </c:forEach> 
		</table>
		<br><br>
